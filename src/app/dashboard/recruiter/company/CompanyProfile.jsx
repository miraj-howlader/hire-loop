...
import { createCompany } from '@/lib/actions/companyes';
...
export default function CompanyProfile({recruiter,recruiterCompnay}) {
    // 1. Core State
    const [company, setCompany] = useState(recruiterCompnay); // Keeps null initially to showcase empty template structure
