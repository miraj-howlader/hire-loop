        ...
        <>
            ...
            <div className='bg-black pt-20 px-4'>
                <footer className="bg-[#131314] w-full max-w-[1350px] mx-auto text-white pt-8 lg:pt-12 px-4 sm:px-8 md:px-16 lg:px-28 rounded-tl-3xl rounded-tr-3xl overflow-hidden">
                    <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-6 gap-8 md:gap-12">
                        ...
                        <div className="lg:col-span-3 space-y-6">
                           <Image src={'/logo.png'} width={80} height={80} alt="Logo" />
                            <p className="text-sm/6 text-neutral-300 max-w-96">It helps you build faster by transforming your design vision into fully functional, production-ready UI components.</p>
                    ...
                    <div className="max-w-7xl mx-auto mt-12 pt-4 mb-8 border-t border-neutral-700 flex justify-between items-center">
                        <p className="text-neutral-400 text-sm">© 2026 Miraj Howlader</p>
